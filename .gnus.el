...
(setq bbdb-file "~/Dropbox/bbdb.db")
...
(setq gnus-posting-styles
      '((".*"
     (name "Hui Peng"
          (address "peng124@purdue.edu"
                   (organization "Computer Science Department, Purdue University")
...
(setq message-send-mail-function 'smtpmail-send-it
      smtpmail-starttls-credentials '(("smtp.purdue.edu" 465 nil nil))
      smtpmail-auth-credentials '(("smtp.purdue.edu" 465 "peng124@purdue.edu" nil))
